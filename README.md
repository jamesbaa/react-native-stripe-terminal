...
React Native wrapper for the [Stripe Terminal](https://stripe.com/docs/terminal/ios) SDK specifically for Smart/Internet readers. (Android Only for now)

## Getting started

First, follow all Stripe instructions under ["Install the Android SDK"](https://stripe.com/docs/terminal/sdk/android#install). Then:

`$ npm install git+https://github.com/jamesbaa/react-native-stripe-terminal.git --save`
